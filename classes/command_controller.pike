...
void subscribe(object id, object response, object view, mixed ln)
{
  ...
  response->redirect(app->controller->listinfo, ({ln}));
}

void unsubscribe(object id, object response, object view, mixed ln)
{
  object list = Fins.DataSource._default.find.lists_by_alt(ln);
...
void setmode(object id, object response, object view, mixed ln)
{
  object list = Fins.DataSource._default.find.lists_by_alt(ln);
  object s;
